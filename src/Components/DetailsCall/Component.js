      ...
      <div className="containrer-app mask">
        <div className="modalBox fade-in">
            <div className="modalBox-Title">
                ...
                <button className="Close" onClick={this.handleCloseDetails}><img src={icoClose}/></button>
            </div>
            <div className="modalBox-Container">
                ...
                <ul className="details">
                  ...
                  { activity.from && <li className='text'><small>📞</small><b>{activity.from}</b></li>}
                  { activity.via && <li className='text'><em>{activity.via}</em></li>}
                  ...
                  { activity.direction && <li className='text'>{activity.direction === 'outbound' ? 'Outbound' : 'Inbound'}</li>}
                  <li className='text'><b>{activity.is_archived ? 'Archived' : 'Not Archived'}</b></li>
                </ul>
            ...
            { !activity.is_archived &&
              <div className="modalBox-Footer">
                <button className="pure-button pure-button-primary" onClick={this.handleUpdateDetails(activity.id)}>Archive Now !</button>
              </div>
            }
        </div>
