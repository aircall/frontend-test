...
const ABSTRACT = {
  COLORS: {
    ...
    LIGHT_TEXT: PRIMITIVE.COLORS.WHITE,
    LIGHT_BACKGROUND: PRIMITIVE.COLORS.WHITE,
    MEDIUM_BACKGROUND: PRIMITIVE.COLORS.MERCURY,
    ...
    LIGHT_ICON: PRIMITIVE.COLORS.WHITE,
    DANGER: PRIMITIVE.COLORS.RED,
  },
  FONT_SIZES: {
...
export const theme = {
  ...
  COMPONENTS: {
    ...
    ACTIVITY_DETAIL: {
      INFO_LIST: {
        BORDER_COLOR: ABSTRACT.COLORS.DARK_BORDER,
        MARGIN: PRIMITIVE.SPACING.M,
        ITEM_SPACING: PRIMITIVE.SPACING.S,
        ZEBRA_COLOR_EVEN: ABSTRACT.COLORS.LIGHT_BACKGROUND,
        ZEBRA_COLOR_ODD: ABSTRACT.COLORS.MEDIUM_BACKGROUND,
      },
      ERROR: {
        COLOR: ABSTRACT.COLORS.ERROR,
      },
      ARCHIVE_BUTTON: {
        BACKGROUND_COLOR: ABSTRACT.COLORS.DANGER,
        COLOR: ABSTRACT.COLORS.LIGHT_TEXT,
        V_PADDING: PRIMITIVE.SPACING.S,
        H_PADDING: PRIMITIVE.SPACING.M,
        MARGIN: PRIMITIVE.SPACING.L,
